...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\mssaa\\OneDrive\\Desktop\\PSYCHOPY\\Motor Sequence_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/mssaa/Downloads/Sequence_Conditions - Sheet1.csv'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        random_2 = data.Routine(
            name='random_2',
            components=[Fixation_2, line1_2, line2_2, line3_2, line4_2, probe_2, key_resp_2],
        )
        ...
        while continueRoutine:
            ...
            if probe_2.status == NOT_STARTED and tThisFlip >= 2-frameTolerance:
                # keep track of start time/frame for later
    ...
    # completed 400.0 repeats of 'trials_2'
